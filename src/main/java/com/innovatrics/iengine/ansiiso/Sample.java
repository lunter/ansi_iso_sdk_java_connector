...
public class Sample {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            int quality = i.getImageQuality(img);
            ...
            quality = i.getImageQuality(img2);
            System.out.println("Second image quality: " + quality);
            final byte[] isoTemplate = i.isoCreateTemplate(img);
            final byte[] ansiTemplate = i.isoConvertToANSI(isoTemplate);
            final byte[] isoTemplate2 = i.isoCreateTemplate(img2);
